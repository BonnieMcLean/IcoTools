...
experiments <- read_csv("ratings/experiment1.csv")
...
# add identifiers (in the format word_MEANING) for the trials -- this is important in case you have homonyms in your data
